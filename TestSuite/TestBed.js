...
export class TestBed{
    ...
    AddTestScenario_AllTypes(name, testsCallbackFunction, postTestsCallbackFunction){
        this.AddTestScenario(name, TestScenarioMode.AllTypes,null,null,false,testsCallbackFunction,postTestsCallbackFunction);
    }
