...
export function testScenario1_testsCallback(testScenario){
    ...
    //testScenario.AddTestCase_ErrorFound("Test Three: Letter Data",testDataThree,getMarks,"", TypeError);

}

//[OPTIONAL] POST_TEST_CALLBACK_TO_USE_POST_TEST_RESULTS_FOR_OTHER_THINGS
export function testScenario1_postTestsCallback(testScenario){
...
//[OPTIONAL] ADDITIONAL_LOCAL_FUNCTIONS_USED_WITHIN_THIS_TESTKIT_SCOPE_ONLY
